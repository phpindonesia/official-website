...
<div class="container" id="content-contain">
 ...
 <?php if($page['sidebar_first']) { $contentwid= "twelve"; } else { $contentwid= "sixteen"; } ?>
...
<div id="copyright" class="container">
  <div class="credit">
    <?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <a href="http://phpindonesia.net/"><?php print $site_name; ?></a> -  
    <?php print t('Developed by'); ?> <a href="https://www.facebook.com/groups/35688476100/" target="_blank">Komunitas PHP Indonesia</a> - 
